...
This project uses local memory to help draft release notes.

```bash
memory dev changelog --since 7d
memory dev release-notes
```

## Public Developer Adoption Release

- Added safer attach/detach flows for AI coding tools.
- Added top-level watch and context commands.
- Polished terminal, CI, privacy, config, map, install, docs, website, and examples.
- Kept fuzzing, mobile, cloud sync, and plugin marketplace out of scope.
